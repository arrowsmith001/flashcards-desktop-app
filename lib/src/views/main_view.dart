...
class _MainViewState extends ConsumerState<MainView>
  ...
  void _initAnimations() {
    _assemblyAnimationController =
        AnimationController(vsync: this, duration: Duration(milliseconds: 500));
    _assemblyAnimationController.addListener(() {
      setState(() {});
    });
    _assemblyAnimation = CurvedAnimation(
        parent: _assemblyAnimationController, curve: Curves.easeInOut);
    ...
    return NavigationRail(
        ...
        destinations: const [
          NavigationRailDestination(
              icon: Icon(Icons.book), label: Text("My decks")),
          NavigationRailDestination(
